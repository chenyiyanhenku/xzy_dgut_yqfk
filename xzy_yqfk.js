...
let xzy_yqfk_ckArr = [];
// let xzy_yffk_UAArr = ['Mozilla/5.0 (Linux; Android 10; BAH3-W09) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.92 Safari/537.36','Mozilla/5.0 (Linux; U; Android 7.0; zh-cn; Redmi Note 4X Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/61.0.3163.128 Mobile Safari/537.36'];
let msg = '';
...
//退出登录 
const logout_info = function(timeout = 10 * 1000) {
    let config = {
        method: 'get',
